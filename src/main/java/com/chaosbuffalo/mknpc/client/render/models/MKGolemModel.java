...
public class MKGolemModel<T extends MKEntity> extends MKBipedModel<T> {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation deformation, float headOffset) {
        ...
        partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 20).addBox(-4.0F, -12.0F, -5.5F, 8.0F, 10.0F, 8.0F, deformation.extend(0.5F)).texOffs(24, 20).addBox(-1.0F, -5.0F, -7.5F, 2.0F, 4.0F, 2.0F), PartPose.offset(0.0F, -7.0f + headOffset, -2.0f));
